...
import type { UserOrganization, CreateOrganizationRequest, ORGANIZATION_ROLE_LABELS, ORGANIZATION_ROLE_COLORS } from '../../../features/organization/models';
...
export class OrgSwitcherComponent {
  ...
  // 過濾出組織（排除個人空間）
  readonly organizationList = computed(() => 
    this.availableOrgs().filter(org => org.type === 'organization')
  );
