...
import type { Project, CreateProjectRequest, UpdateProjectRequest, ProjectQueryParams, ProjectListResponse } from '../models';
...
export class ProjectService {
  ...
  getProjects(params?: ProjectQueryParams): Observable<ProjectListResponse> {
    ...
    const url = orgId ? `/api/organizations/${orgId}/projects` : `/api/users/me/projects`;
